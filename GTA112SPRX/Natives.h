...
namespace CAM
{
	static Vector3 _GET_GAMEPLAY_CAM_ROT(int p0) { return invoke<Vector3>(0x1FFBEFC5, p0); } // 0x1FFBEFC5
	...
	static Any CREATE_CAM_WITH_PARAMS1(char* camName, float posX, float posY, float posZ, float rotX, float rotY, float rotZ, float fov, BOOL p8, int p9) { return invoke<Any>(0x23B02F15, camName, posX, posY, posZ, rotX, rotY, rotZ, fov, p8, p9); } // 0x23B02F15 0x23B02F15
...
namespace UI
{
	static void _SET_HUD_COLOUR(int hudIndex, int r, int g, int b, int a) { invoke<Void>(0xF6E7E92B, hudIndex, r, g, b, a); } // 0xF6E7E92B
...
namespace GRAPHICS
{
	...
	static void DRAW_SCALEFORM_MOVIE(int scaleformHandle, float x, float y, float width, float height, int red, int green, int blue, int alpha, int p9) { invoke<Void>(0x48DA6A58, scaleformHandle, x, y, width, height, red, green, blue, alpha, p9); } // 0x48DA6A58
...
namespace NETWORK
{
	...
	static void NETWORK_HANDLE_FROM_PLAYER3(Ped PedHandle, int* FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); } // 0xD3498917
